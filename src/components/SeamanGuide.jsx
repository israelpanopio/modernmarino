...
function SeamanGuide() {
  return (
    <div className="cntr">
      ...
      <p className="bodyheader">Welcome to Modern Marino!</p>
      <p style={{ textAlign: "center" }}>
        ...
        Follow us on Facebook and Youtube for more!
      </p>
      <p style={{ textAlign: "center" }}>#modernmarinoako #wiseaman</p>
    </div>
  );
}

export default SeamanGuide;
